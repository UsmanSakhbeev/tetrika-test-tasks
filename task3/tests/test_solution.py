...
EDGE_TESTS = [
    ({"lesson": [0, 100], "pupil": [], "tutor": []}, 0),
    ({"lesson": [100, 200], "pupil": [0, 50], "tutor": [10, 40]}, 0),
    ({"lesson": [100, 200], "pupil": [210, 220], "tutor": [215, 230]}, 0),
    ({"lesson": [0, 20], "pupil": [0, 10], "tutor": [10, 20]}, 0),
    ({"lesson": [0, 20], "pupil": [1, 19], "tutor": [0, 20]}, 18),
]


@pytest.mark.parametrize("intervals, expected", BASE_TESTS + EDGE_TESTS)
